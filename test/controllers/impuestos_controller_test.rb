...
class ImpuestosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create impuesto" do
    assert_difference('Impuesto.count') do
      post impuestos_url, params: { impuesto: { estado: @impuesto.estado, nombre: @impuesto.nombre, valor: @impuesto.valor } }
    end
  ...
  test "should update impuesto" do
    patch impuesto_url(@impuesto), params: { impuesto: { estado: @impuesto.estado, nombre: @impuesto.nombre, valor: @impuesto.valor } }
