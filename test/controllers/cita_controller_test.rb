...
class CitaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create citum" do
    assert_difference('Citum.count') do
      post cita_url, params: { citum: { empleado_id: @citum.empleado_id, fecha: @citum.fecha, servicio_id: @citum.servicio_id, user_id: @citum.user_id } }
    end
  ...
  test "should update citum" do
    patch citum_url(@citum), params: { citum: { empleado_id: @citum.empleado_id, fecha: @citum.fecha, servicio_id: @citum.servicio_id, user_id: @citum.user_id } }
