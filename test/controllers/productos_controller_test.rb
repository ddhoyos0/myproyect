...
class ProductosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post productos_url, params: { producto: { cantidad: @producto.cantidad, codigo_producto: @producto.codigo_producto, marca_id: @producto.marca_id, nombre: @producto.nombre, unidad: @producto.unidad, valor_unitario: @producto.valor_unitario } }
    end
  ...
  test "should update producto" do
    patch producto_url(@producto), params: { producto: { cantidad: @producto.cantidad, codigo_producto: @producto.codigo_producto, marca_id: @producto.marca_id, nombre: @producto.nombre, unidad: @producto.unidad, valor_unitario: @producto.valor_unitario } }
